...
%>
 ...
 ResultSet rs=null;
 	...
 	String sql = "SELECT * FROM `issue_books` WHERE StudentID='"+userid+"'";
...
<header id="main-header">
    ...
    <nav >
      <div >
        <ul>
		<li><a href="studentPannel.jsp">Home</a></li>  
          <li><a href="StudentIssuedBooks.jsp">MY BOOKS</a></li>  		  
...
" WHERE StudentID='"+userid+"' and issue_books.Date_of_Ret<CURDATE()";
...
<a href="StudentIssuedBooks.jsp?id=<%=rs1.getInt("BookID")%>">Calculate your fine </a>
<br>
